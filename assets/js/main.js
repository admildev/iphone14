...
const showMenu = (toggleId, navId) => {
    ...
    // Validate that variable existence
    if(toggle && nav){
...
function scrollActive() {
    ...
    sections.forEach(current => {
        ...
        if (scrollY > sectionTop && scrollY <= sectionTop + sectionHeight) {
            // Add active-link to the classList of current section through 'a' tag 
...
themeButton.addEventListener('click', () => {
    ...
    // we dave the theme and the current icon that the use chose
